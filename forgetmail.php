...
if(isset($_POST['submit'])){
	...
	$check=mysqli_num_rows($result=mysqli_query($con,"select * from user where email='$email'"));
	
	if($check!=1){
		$msg="Email is not found present";
	}else{
		...
		$mailHtml="Please confirm your account registration by clicking the button or link below: <a href='http://127.0.0.1/dreamproject/forget.php?id=$verification_id'>reset pass</a>";
...
<div class="signup-form">
    <form method="post">
		...
		<div class="form-group">
            <button type="submit"  name="submit" class="btn btn-success btn-lg btn-block">reset pass</button>
        </div>
    </form>
</div>
</body>
